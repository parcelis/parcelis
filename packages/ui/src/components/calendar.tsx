  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "flex h-9 flex-1 items-center justify-center text-xs font-medium text-parcelis-gray dark:text-parcelis-porcelain/70",
      ...
      components={{
        Chevron: ({ orientation, className: iconClassName, ...iconProps }) =>
          orientation === "left" ? (
            ...
            <ChevronDown className={cn("size-4", iconClassName)} {...iconProps} />
          ) : (
