    ...
    <main className="flex-1">
      <section className="transition-[padding] duration-200 lg:pl-[var(--parcelis-sidebar-width)]">
        ...
        <div className="parcelis-page-shell flex flex-col gap-5 lg:flex-row">
          <ApplicationsRail active="templates" />
          <div className="min-w-0 flex-1">
            <section className="rounded-lg bg-parcelis-charcoal p-6 text-white">
              ...
              <h1 className="mt-5 text-3xl font-bold md:text-5xl">Application templates</h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">
                Build reusable application forms for prospective tenants.
              </p>
            </section>
